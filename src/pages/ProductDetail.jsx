...
export default function ProductDetail() {
  ...
  let [quantity, setQuantity] = useState(+(cartProduct?.quantity ?? 0));
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6">
              <div className="product__details__text">
                ...
                <div className="product__details__price">${product.price - ((product.discount / 100) * product.price)}</div>
                ...
                <div className="product__details__quantity">
                  <div className="quantity">
                    <div className="pro-qty">
                      ...
                      <input type="text" value={quantity} onChange={inputChange}/>
                      <button style={{ border: "none" }} onClick={increment}>+</button>
                    </div>
                  </div>
                </div>
                <Link className="primary-btn" onClick={addToCart}>ADD TO CARD</Link>
