...
export default function ProductCreateOrUpdate() {
  ...
  let { name, slug, shortDescription, description, image, price, discount, quantity, category, status }
    = formData
    ...
    <div className="card">
      ...
      <div className="card-body">
        <form onSubmit={submit}>
          ...
          <div className="mb-3">
            <label htmlFor="discount" className="form-label">Discount (in <b>%</b>)</label>
            <input
              type="number"
              step="any"
              className="form-control"
