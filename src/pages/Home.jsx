        ...
        <div className="container">
          <div className="row">
            ...
            <OwlCarousel className='owl-theme categories__slider'
              items={4} margin={10} loop={true} autoplay={true} autoplayTimeout={3000} nav={true} smartSpeed={1000}>
              <div className="col-lg-3">
              ...
              <div className="col-lg-3">
                <div className="categories__item set-bg"
                  style={{ backgroundImage: "url(./assets/img/categories/cat-2.jpg)" }}
              ...
              <div className="col-lg-3">
                <div className="categories__item set-bg"
                  style={{ backgroundImage: "url(./assets/img/categories/cat-3.jpg)" }}
              ...
              <div className="col-lg-3">
                <div className="categories__item set-bg"
                  style={{ backgroundImage: "url(./assets/img/categories/cat-4.jpg)" }}
              ...
              <div className="col-lg-3">
                <div className="categories__item set-bg"
                  style={{ backgroundImage: "url(./assets/img/categories/cat-5.jpg)" }}
